...
public class Main {
        public static void main(String[] args) {
                ...
                List<Reader> readers = em
                                .createQuery("select r from Reader r where :book member of r.readBooks", Reader.class)
                ...
                List<Author> authors = em
                                .createQuery("select distinct a from Author a join a.writtenBooks b join b.readers r",
                                                Author.class)
                                .getResultList();
